...
function getLevelComponent() {
    return '<div class="gameLevel">Уровень 1</div>';
}

function getNickNameComponent() {
    return '<div class="playerName">User</div>';
}
